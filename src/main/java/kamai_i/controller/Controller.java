...
import kamai_i.controller.osu.OsuController;
...
import kamai_i.model.managment.Management;
...
public class Controller {
    ...
    private void initialize() {
        ...
        wordLengthCheckBox.selectedProperty().addListener(_ -> wordLengthContainer.setDisable(!wordLengthCheckBox.isSelected()));
        wordTypeCheckBox.selectedProperty().addListener(_ -> wordTypeContainer.setDisable(!wordTypeCheckBox.isSelected()));
        wordLinkedCheckBox.selectedProperty().addListener(_ -> wordLinkedContainer.setDisable(!wordLinkedCheckBox.isSelected()));
        wordEmotionalityCheckBox.selectedProperty().addListener(_ -> wordEmotionalityContainer.setDisable(!wordEmotionalityCheckBox.isSelected()));
        wordVulgarityCheckBox.selectedProperty().addListener(_ -> wordVulgarityContainer.setDisable(!wordVulgarityCheckBox.isSelected()));
        wordFormalityCheckBox.selectedProperty().addListener(_ -> wordFormalityContainer.setDisable(!wordFormalityCheckBox.isSelected()));
        typeParentCheckBox.selectedProperty().addListener(_ -> typeParentContainer.setDisable(!typeParentCheckBox.isSelected()));

        wordSelectAllCheckBox.selectedProperty().addListener(_ -> {
        ...
        letterSelectAllCheckBox.selectedProperty().addListener(_ -> {
        ...
        typeSelectAllCheckBox.selectedProperty().addListener(_ -> {
        ...
        wordSearch.textProperty().addListener((_, _, _) -> reloadWordsNav());
        typeSearch.textProperty().addListener((_, _, _) -> reloadTypesNav());
        letterSearch.textProperty().addListener((_, _, _) -> reloadLettersNav());
        ...
        wordSortComboBox.setOnAction(_ -> reloadWordsNav());
        ...
        letterSortComboBox.setOnAction(_ -> reloadLettersNav());
        ...
        typeSortComboBox.setOnAction(_ -> reloadTypesNav());
